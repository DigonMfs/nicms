<?php
    ...
    if (isset($_GET["level"]) && isset($_GET["parent_id"])) {
        ...
        //look if parameters are integers, and thus not changed on spectate element
        if (!is_int($level) && !is_int($parent_id)) {
            ...
            echo "<p class='alert alert-danger' role='alert'>Category not valid</p>";
            die();
        }// if is_int
