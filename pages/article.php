        ...
        <main class="general-main articles-main container">
            ...
            <nav class="container general-nav articles-article-breadcrumbs" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="<?php echo LinkUrl::LINKURL; ?>index.php?catID=<?php echo $articleCatID; ?>&subCatID=<?php echo $articleSubcatID?>&name=<?php echo $articleSubcat ?>"><?php echo $articleSubcat ?></a></li>
